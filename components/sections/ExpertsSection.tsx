...
export function ExpertsSection() {
  return (
    <div className="star w-[100%] mt-0 md:mt-2 lg:pt-4 px-6 text-white md:px-10 overflow-hidden">

      {/* Section Title */}
      <h3 className="text-2xl md:text-4xl font-bold text-white text-center underline underline-offset-[8px] decoration-[#E94C60] decoration-4 pt-6 md:pt-8 lg:pt-4">
        Our All-Star Experts
      </h3>

      <p className="text-lg md:text-lg font-semibold lg:font-regular text-white text-center pt-3 px-10 md:px-0">
        We strive to offer you the best medical assistance from the best counsellors in India.
      </p>

      {/* Content */}
      <div className="flex flex-row mt-0 lg:-mt-6 justify-end">

        {/* Carousel Section */}
        <div className="w-full pl-0 lg:pl-24 lg:w-[45%] ml-auto">
        ...
        {/* Grid Section */}
        <div className="hidden w-[55%] h-[30rem] px-10 lg:p-10 lg:grid grid-cols-2 md:grid-cols-3 grid-rows-4 md:grid-rows-3 mt-6 md:mt-0 text-sm lg:text-md">
          {experts.map((expert) => (
            <div key={expert.id}>
              <Image
                alt=""
